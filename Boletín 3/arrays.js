...
function mostrarNumPaises(){
 return document.write(paises.length);
}

function mostrarPaises(){
    
    return paises.forEach((e)=>document.write(e + "<br>"));
}

function mostrarPaisesAlReves(){
    let paisesReves =[... paises.reverse()];
    return paisesReves.forEach((e)=>document.write(e + "<br>"));
}
function mostrarPaisesOrdenados(){

    return paises.sort().forEach((e)=>document.write(e + "<br>"))
}
function anadirPaisPrincipio(){
     paises.unshift(prompt("Introduce el país que quieras introducir"));
     return paises.forEach((e)=>document.write(e + "<br>"));
}
function anadirPaisFinal(){
    paises.push(prompt("Introduce el país que quieras introducir"));
    return paises.forEach((e)=>document.write(e + "<br>"));
}
function eliminarPaisPrincipio(){
    document.write("Se ha eliminado "+paises[0] +"<br>");
    paises.shift();
    paises.forEach((e)=>document.write(e + "<br>"));
}
function eliminarPaisFinal(){
    document.write("Se ha eliminado "+paises[paises.length-1] +"<br>");
    paises.pop();
    paises.forEach((e)=>document.write(e + "<br>"));
}
function mostrarPaisEspecifico(){
